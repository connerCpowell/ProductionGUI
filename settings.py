...
SEND_DIRECTLY          = 0  #  0 - dump into the pending directory for later upload
...
INTENSITY_WET          = 900   # 'witness the power of this fully armed and operational battle station'
INTENSITY_DRY          = 900   # when no liquid is behind a valve
...
BURN_PATTERN_L1        = 'BD,DB'   # 'C' Seems reasonably accurate
BURN_PATTERN_L2        = 'BD,DB'   # but when the target is smaller it can
